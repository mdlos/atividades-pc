...
/**
 * Classe Server que gerencia um pool de threads de tamanho fixo para executar tarefas.
 */
public class Server {
    private ThreadPoolExecutor executor;

    public Server() {
        // Cria um pool de threads com tamanho fixo (5 threads)
    ...
    public void executeTask(Task task) {
        ...
        System.out.printf("Server: Total de Tarefas Submetidas: %d\n", executor.getTaskCount());
